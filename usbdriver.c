 ...
 *  \file : usb_driver.c 
 *  
 *  \details: SIMPLE USB driver explanations
 *
 *  \author : harsh Dixit
 *  \
...
#define USB_VENDOR_ID (0x22d9) // USB device's vendor
#define USB_PRODUCT_ID (0x2764) // USB device's product
...
//usb_device_id provides a list of different types of USB devices 
